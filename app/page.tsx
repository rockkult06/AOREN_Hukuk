...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Ekibimiz Bölümü */}
      <section id="team" className="min-h-screen py-20 px-2 md:px-0 mt-16 md:mt-0 mx-auto max-w-[420px] overflow-hidden">
      ...
      <section id="expertise" className="min-h-screen relative py-20 px-2 md:px-0 mt-16 md:mt-0 mx-auto max-w-[420px] overflow-hidden">
      ...
      {/* Hakkımızda Bölümü */}
      <section id="about" className="min-h-screen relative py-20 px-2 md:px-0 mt-16 md:mt-0 mx-auto max-w-[420px] overflow-hidden">
        <div className="container mx-auto px-2 md:px-4 relative z-10">
      ...
      {/* Ofislerimiz Bölümü */}
      <section id="offices" className="min-h-screen relative py-20 px-2 md:px-0 mt-16 md:mt-0 mx-auto max-w-[420px] overflow-hidden">
        <div className="container mx-auto px-2 md:px-4 relative z-10">
          <div className="text-center mb-16">
      ...
      <section id="responsibility" className="min-h-screen relative py-20 px-2 md:px-0 mt-16 md:mt-0 mx-auto max-w-[420px] overflow-hidden">
        <div className="container mx-auto px-2 md:px-4 relative z-10">
          <div className="text-center mb-16">
      ...
      <section id="careers" className="min-h-screen relative py-20 px-2 md:px-0 mt-16 md:mt-0 mx-auto max-w-[420px] overflow-hidden">
        <div className="container mx-auto px-2 md:px-4 relative z-10">
          <div className="text-center mb-16">
      ...
      <section id="digital-services" className="min-h-screen relative py-20 px-2 md:px-0 mt-16 md:mt-0 mx-auto max-w-[420px] overflow-hidden">
        <div className="container mx-auto px-2 md:px-4 relative z-10">
          <div className="text-center mb-16">
      ...
      {/* İletişim Bölümü */}
      <section id="contact" className="min-h-screen relative py-20 px-2 md:px-0 mt-16 md:mt-0 mx-auto max-w-[420px] overflow-hidden">
        <div className="container mx-auto px-2 md:px-4 relative z-10">
          <div className="text-center mb-16">

...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Ekibimiz Bölümü */}
      <section id="team" className="min-h-screen py-12 px-1 md:px-0 mt-16 md:mt-0">
        <div className="container mx-auto w-full max-w-[400px] overflow-x-hidden px-1 md:px-4">
          <div className="text-center mb-6 md:mb-12">
            <h2 className="text-2xl md:text-5xl font-bold text-white mb-2 md:mb-6">{t('team.title')}</h2>
            <p className="text-base md:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              {t('team.description')}
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-12 max-w-6xl mx-auto">
            {/* İlk satır - 2 kişi */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:col-span-2">
              {employeesData.slice(0, 2).map((member, index) => (
                <div 
                  key={index}
                  className="bg-white/10 backdrop-blur-sm rounded-lg md:rounded-[20px] border border-white/20 shadow-lg p-3 md:p-8 hover:shadow-xl hover:bg-white/15 transition-all duration-300 cursor-pointer hover:scale-105"
      ...
      <section id="expertise" className="min-h-screen relative py-12 px-1 md:px-0 mt-16 md:mt-0">
        <div className="container mx-auto w-full max-w-[400px] overflow-x-hidden px-1 md:px-4 relative z-10">
          <div className="text-center mb-6 md:mb-12">
            <h2 className="text-2xl md:text-5xl font-bold text-white mb-2 md:mb-6">{t('expertise.title')}</h2>
            <p className="text-base md:text-xl text-white/90 max-w-4xl mx-auto leading-relaxed mb-4 md:mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8 max-w-7xl mx-auto">
            {expertiseData.map((expertise, index) => (
              <div 
                key={index}
                className="bg-white/15 backdrop-blur-[10px] rounded-lg md:rounded-[20px] border border-white/20 shadow-2xl p-3 md:p-8 hover:shadow-xl hover:bg-white/25 transition-all duration-300 hover:scale-105 cursor-pointer min-h-[180px] md:min-h-[220px] flex flex-col justify-between"
      ...
      {/* Hakkımızda Bölümü */}
      <section id="about" className="min-h-screen relative py-12 px-1 md:px-0 mt-16 md:mt-0">
        <div className="container mx-auto w-full max-w-[400px] overflow-x-hidden px-1 md:px-4 relative z-10">
      ...
      {/* Ofislerimiz Bölümü */}
      <section id="offices" className="min-h-screen relative py-12 px-1 md:px-0 mt-16 md:mt-0">
        <div className="container mx-auto w-full max-w-[400px] overflow-x-hidden px-1 md:px-4 relative z-10">
          <div className="text-center mb-16">
      ...
      <section id="responsibility" className="min-h-screen relative py-12 px-1 md:px-0 mt-16 md:mt-0">
        <div className="container mx-auto w-full max-w-[400px] overflow-x-hidden px-1 md:px-4 relative z-10">
          <div className="text-center mb-16">
      ...
      <section id="careers" className="min-h-screen relative py-12 px-1 md:px-0 mt-16 md:mt-0">
        <div className="container mx-auto w-full max-w-[400px] overflow-x-hidden px-1 md:px-4 relative z-10">
          <div className="text-center mb-16">
      ...
      <section id="digital-services" className="min-h-screen relative py-12 px-1 md:px-0 mt-16 md:mt-0">
        <div className="container mx-auto w-full max-w-[400px] overflow-x-hidden px-1 md:px-4 relative z-10">
          <div className="text-center mb-16">
      ...
      {/* İletişim Bölümü */}
      <section id="contact" className="min-h-screen relative py-12 px-1 md:px-0 mt-16 md:mt-0">
        <div className="container mx-auto w-full max-w-[400px] overflow-x-hidden px-1 md:px-4 relative z-10">
          <div className="text-center mb-16">
